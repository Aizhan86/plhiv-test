...
class PatientCardLocators(object):
    ...
    WORKING_SCHEDULE = "$('div[data-field=working_hours] .ui.dropdown')"
    ...
    CONTACT_PERSON_EXISTENCE = "$('div[data-field=nalich_kontakt_lic] .ui.dropdown')"
    ...
    CONTACT_PERSON_BIRTHDAY = "$('#contact_date_birth_modal')"
    ...
    CONTACT_SURVEY_EDIT = "$('#obsled_table a[action-type=edit]')"
    ...
    CONTACT_SURVEY_CANCEL = "$('#obsled_modal .ui.red.deny.button')"
    ...
    CONTACT_DATE_END = "$('#contact_date_end_modal')"
    CONTACT_AREA = "$('#contact_modal div[data-field=contact_obl_modal] .ui.dropdown')"
    CONTACT_UNIT_AREA_SEARCH = "$('#contact_modal div[data-field=contact_adm_ed_modal] input.search')"
    ...
    CONTACT_PERSON_CANCEL = "$('#contact_modal .ui.red.deny.button')"
    ...
    ARV_RECIPE_NUM = "$('div[data-field=art_preparat_number_receipt_modal] input')"
    ARV_DAY_NUM = "$('div[data-field=art_preparat_count_day_modal] input')"
    ARV_MEDICINE_PER_DAY = "$('div[data-field=art_preparat_count_drugs_day_modal] input')"
    ARV_NEXT_DATE = "$('#art_preparat_next_day_vidachi_modal')"
    ...
    ARV_ISSUANCE_CANCEL= "$('#modal_perinat_uchet_preparat .ui.red.deny.button')"
    PCP_PROPHYLAXIS_START_DATE = "$('div[data-field=child_pcp_date_start_modal] input')"
    PCP_PROPHYLAXIS_END_DATE = "$('div[data-field=child_pcp_date_end_modal] input')"
    HIV_STATUS_P_TAB = "$('div[data-field=child_hiv_state_modal] .ui.dropdown')"
    HIV_DETERMINATION_DATE_P_TAB = "$('div[data-field=child_date_check_modal] input')"
    ...
    ART_ISSUANCE_EDIT = "$('#is_table a[action-type=edit]')"
    ...
    ART_RECIPE_NUM = "$('div[data-field=art_preparat_number_receipt_modal] input')"
    ...
    ART_ISSUANCE_CANCEL = "$('#modal_art_preparaty .ui.red.deny.button')"
    ...
    ART_INFORMATION_CANCEL = "$('#modal_svedeniya_art .ui.red.deny.button')"
    ...
    PREG_ARV_ISSUANCE_TABLE_ADD = "$('#is_table a[action-type=add]')"
    ...
    PREG_ARV_RECIPE_NUM = "$('div[data-field=art_preparat_number_receipt_modal] input')"
    ...
    PREG_ARV_ISSUANCE_TABLE_EDIT = "$('#is_table a[action-type=edit]')"
    PREG_ARV_ISSUANCE_SAVE = "$('#modal_berem_preparat .ui.green.approve.button')"
    PREG_ARV_ISSUANCE_CANCEL = "$('#modal_berem_preparat .ui.red.deny.button')"
    PREG_ARV_ISSUANCE_EDIT = "$('#is_table a[action-type=edit]')"
    ...
    CHILD_ARV_RECIPE_NUM = "$('div[data-field=art_preparat_number_receipt_modal] input')"
    ...
    CHILD_ARV_ISSUANCE_SAVE = "$('#modal_child_info .ui.green.approve.button')"
    PREG_ARV_ISSUANCE_CHILD_CANCEL = "$('#modal_berem_preparat_future .ui.red.deny.button')"
    INFORMATION_CHILDREN_ADD = "$('#child_info_table a[data-name=button-for-add-child]')"
    ...
    INFORMATION_CHILDREN_EDIT = "$('#child_info_table a[action-type=edit]')"
    INFORMATION_CHILDREN_CANCEL = "$('#modal_child_info .ui.red.deny.button')"
    PREGNANCY_SAVE = "$('#modal_preg .ui.green.approve.button')"
    PREGNANCY_CANCEL = "$('#modal_preg .ui.red.deny.button')"
    ...
    PREV_THER_CANCEL = "$('#modal_therapy_opurt_zabolev .ui.red.deny.button')"
    ...
    OST_CANCEL = "$('#modal_opioid_therapy .ui.red.deny.button')"
    ...
    VGS_TREAT_CANCEL = "$('#modal_hcv_therapy .ui.red.deny.button')"
...
class AnalysisPageLocators(object):
    REGISTERS_MENU = "$('.ui.fixed.inverted.menu.main div:eq(1)')"
...
class ArvRegisterLocators(object):
    ARV_REGISTERS_MENU = "$('.ui.fixed.inverted.menu.main div:eq(8)')"
    ...
    RECEIPT_REGISTER = "$('div[data-name=arv-journal-list] a[data-name=coming]')"
    ...
    MEDICATION_CHOICE = "$('#1 > td:nth-child(1) > a')"
    ...
    MEDICATION_SERIUS_NUM = "$('td[data-field=party_number_drug_1] input')"
    MEDICATION_SUM = "$('td[data-field=sum_drug_1] input')"
    RECEIPT_REGISTER_SAVE = "$('#save_prihod')"
    RECEIPT_REGISTER_EDIT = "$('#gridContainer a.blue')"
    RECEIPT_REGISTER_CANCEL = "$('a.ui.red.icon.button')[0]"

    WRITE_OFF_REGISTER = "$('div[data-name=arv-journal-list] a[data-name=debit]')"
    WRITE_OFF_ADD = "$('#addDebit')"
    EXPENSE_TYPE = "$('div[data-field=type_send] .ui.dropdown')"
    WAYBILL_DATE = "$('div[data-field=date_send] input')"
    SENDER_NAME = "$('#fio_otpr')"
    WO_BUDGET_TYPE = "$('div[data-field=ui_budjet_type] .ui.dropdown')"
    WO_PROGRAMM = "$('div[data-field=ui_programma] .ui.dropdown')"
    RECIPIENT_ORG = "$('div[data-field=poluch_id] .ui.dropdown')"
    WO_RECIPIENT_NAME = "$('#fio_poluch')"
    WRITE_OFF_REASON = "$('div[data-field=spr_prichina_spisaniya_id] .ui.dropdown')"
    WRITE_OFF_SAVE = "$('#save_debit')"
    WRITE_OFF_EDIT = "$('#gridContainer a.blue')"
    WRITE_OFF_CANCEL = "$('a.ui.red.icon.button')[0]"

    BALANCE_REGISTER = "$('div[data-name=arv-journal-list] a[data-name=remains]')"
