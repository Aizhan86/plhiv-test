...
class PatientCardLocators(object):
    ...
    RELATED_DISEASE_HIV_STAGE_CHOICE = "$('#modal_oppurt_hiv div[data-field=diagnoz_opurt_stage_modal] .menu.transition.hidden .item')"
    ...
    RECOM_CONSULTATION_ADD = "$('#recomended_obsled_table a[action-type=add]')"
    CONSULTATION_DATE = "$('#modal_recomended_obsled .ui.calendar')"
    CONSULTATION = "$('#modal_recomended_obsled div[data-field=recomended_obsled_obsled_modal] .ui.dropdown')"
    CONSULTATION_DESCRIPTION = "$('#recomended_obsled_description_modal')"
    RECOM_CONSULTATION_SAVE = "$('#modal_recomended_obsled .ui.green.approve.button')"
    RECOM_SCREENING_ADD = "$('#recomended_consultation_table a[action-type=add]')"
    SCREENING_DATE = "$('#modal_recomended_consultation .ui.calendar')"
    SURVEY = "$('#modal_recomended_consultation div[data-field=recomended_obsled_obsled_modal] .ui.dropdown')"
    SCREENING_DESCRIPTION = "$('#recomended_consultation_description_modal')"
    RECOM_SCREENING_SAVE = "$('#modal_recomended_consultation .ui.green.approve.button')"
    ...
    NOSOLOGY_CHOICE = "$('#modal_refferals div[data-field=refferals_nozology_modal] > div[class=menu transition hidden] div:eq(0) .item')"
...
class WorkJournalLocators(object):
    HOME_ICON = (By.CSS_SELECTOR, ".header.item .home.icon")
