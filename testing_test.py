...
class TestPlhiv():
    ...
    @pytest.mark.smoke
    @pytest.mark.skipif(test_registration_of_adult == "FAILED", reason="patient id wasn't taken")
    def test_HIV_antibody_testing_OGC_modal(self, browser):
        login(browser)
        zhetysai_user_opens_card_of_adult(browser)
        register_page = RegisterPage(browser, browser.current_url)
    ...
    def test_HIV_antibody_testing_KNCDIZ_modal(self, browser):
        login(browser)
        kncdiz_user_opens_card_of_adult(browser)
        register_page = RegisterPage(browser, browser.current_url)
    ...
    @pytest.mark.skipif(test_registration_of_adult == "FAILED", test_pregnancy_modal == "FAILED", reason="patient id wasn't taken")
